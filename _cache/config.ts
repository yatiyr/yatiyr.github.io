...
export default {
  global: {
     ...
     */
    opg: {
      'profile:first_name': 'Eren',
      'profile:gender': 'male', // male, female
      'profile:last_name': 'Dere',
    },
  ...
  data: {
     ...
     */
    socialMedia: [
      { name: 'Github', icon: 'github', link: 'https://github.com/yatiyr/' },
      { name: 'LinkedIn', icon: 'linkedin', link: 'https://www.linkedin.com/in/eren-dere/' },
    ],
  },
